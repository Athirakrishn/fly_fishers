...
class Deputydirector(models.Model):
    deputydirector_id = models.AutoField(primary_key=True)
    ...
    contact_no = models.CharField(db_column='contact no', max_length=20)  # Field renamed to remove unsuitable characters.
    email = models.CharField(max_length=45)
    password = models.CharField(max_length=45)

    class Meta:
        managed = False
        db_table = 'deputydirector'
